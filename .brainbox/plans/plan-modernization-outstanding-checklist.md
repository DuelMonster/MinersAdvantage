...
- Milestone 2 progress note: Wired platform hook-up for Fabric block-break interception in [ModEntry.java](src/main/java/uk/co/duelmonster/minersadvantage/ModEntry.java) via player-scoped interception entrypoint in [WorkerRuntimeService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/processing/WorkerRuntimeService.java).
...
- [x] Implement Illumination placement strategies and manual modes.
- [x] Implement Captivation, Cropination, Cultivation, Pathanation, Lumbination, Veination behaviors.
- [x] Implement Substitution full policy behavior (mining + combat).
...
- Milestone 3 progress note: Added concrete utility planning/runtime execution in [IlluminationCoreService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/utility/IlluminationCoreService.java), [PathanationCoreService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/utility/PathanationCoreService.java), [VeinationCoreService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/utility/VeinationCoreService.java) and wired outputs in [IlluminationComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/utility/IlluminationComponent.java), [PathanationComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/utility/PathanationComponent.java), [VeinationComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/utility/VeinationComponent.java), [SubstitutionComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/utility/SubstitutionComponent.java).
- Milestone 3 progress note: Completed the remaining utility parity depth by expanding [IlluminationCoreService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/utility/IlluminationCoreService.java) and [IlluminationComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/utility/IlluminationComponent.java) with manual placement hints and depletion reporting, and by expanding [SubstitutionCoreService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/substitution/SubstitutionCoreService.java) and [SubstitutionComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/utility/SubstitutionComponent.java) with mining/combat policy selection plus switch-back behavior, covered by [IlluminationCoreServiceTest.java](src/test/java/uk/co/duelmonster/minersadvantage/common/services/utility/IlluminationCoreServiceTest.java), [SubstitutionCoreServiceTest.java](src/test/java/uk/co/duelmonster/minersadvantage/common/services/SubstitutionCoreServiceTest.java), and [UtilityComponentsRuntimeTest.java](src/test/java/uk/co/duelmonster/minersadvantage/common/feature/utility/UtilityComponentsRuntimeTest.java).
- Milestone 3 progress note: Replaced farming/harvest/captivation placeholders with concrete runtime outputs in [CropinationCoreService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/farming/CropinationCoreService.java), [FarmingCoreService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/farming/FarmingCoreService.java), [LumbinationCoreService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/harvest/LumbinationCoreService.java), [CaptivationCoreService.java](src/main/java/uk/co/duelmonster/minersadvantage/common/services/captivation/CaptivationCoreService.java) and component wiring in [CropinationComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/farming/CropinationComponent.java), [CultivationComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/farming/CultivationComponent.java), [LumbinationComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/harvest/LumbinationComponent.java), [CaptivationComponent.java](src/main/java/uk/co/duelmonster/minersadvantage/common/feature/captivation/CaptivationComponent.java), with runtime coverage in [FarmingHarvestComponentsRuntimeTest.java](src/test/java/uk/co/duelmonster/minersadvantage/common/feature/farming/FarmingHarvestComponentsRuntimeTest.java) and service tests.

Milestone 4: Config parity and server override parity
- [x] Expand config records to match required parity fields.
- [x] Implement synced config payload path (client -> server and enforced merge).
- [x] Add per-feature server override enforcement switches.
- [x] Validate defaults and range policy with tests.
- Commit plan: ✨feature config parity; ✅test config enforcement coverage.
- Milestone 4 progress note: Expanded feature config records under [src/main/java/uk/co/duelmonster/minersadvantage/common/config](src/main/java/uk/co/duelmonster/minersadvantage/common/config) to carry legacy parity fields while preserving current constructor call sites, and added typed aggregate config models in [SyncedClientConfig.java](src/main/java/uk/co/duelmonster/minersadvantage/common/config/SyncedClientConfig.java), [CommonConfig.java](src/main/java/uk/co/duelmonster/minersadvantage/common/config/CommonConfig.java), [ClientConfig.java](src/main/java/uk/co/duelmonster/minersadvantage/common/config/ClientConfig.java), and [ServerOverridesConfig.java](src/main/java/uk/co/duelmonster/minersadvantage/common/config/ServerOverridesConfig.java).
