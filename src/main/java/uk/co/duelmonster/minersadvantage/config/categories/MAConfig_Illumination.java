...
public class MAConfig_Illumination extends MAConfig_BaseCategory {
  ...
  public boolean useBlockLight() {
    if (parentConfig != null && parentConfig.serverOverrides != null &&
        parentConfig.serverOverrides.enforceIlluminationSettings.get())
   ...
   */
  public void setUseBlockLight(boolean value) {
    useBlockLight.set(value);
  }
   ...
   */
  public void setLowestLightLevel(int value) {
    lowestLightLevel.set(value);
  }
