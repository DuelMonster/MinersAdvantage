...
public class MAConfig_Lumbination extends MAConfig_BaseCategory {
  ...
  private final ConfigValue<List<? extends String>> logs;
  private final ConfigValue<List<? extends String>> leaves;
  private final ConfigValue<List<? extends String>> axes;
  ...
  public MAConfig_Lumbination(ForgeConfigSpec.Builder builder) {
    ...
    logs = builder
        ...
        .defineList("logs", MAConfig_Defaults.Lumbination.logs, obj -> obj instanceof String);

    leaves = builder
        .comment("List of Leaf block IDs.")
        .translation("minersadvantage.lumbination.leaves")
        .defineList("leaves", MAConfig_Defaults.Lumbination.leaves, obj -> obj instanceof String);

    axes = builder
        .comment("List of vaild Axe IDs.")
        .translation("minersadvantage.lumbination.axes")
        .defineList("axes", MAConfig_Defaults.Lumbination.axes, obj -> obj instanceof String);
  }
   ...
   */
  public void setChopTreeBelow(boolean value) {
    chopTreeBelow.set(value);
  }
   ...
   */
  public void setDestroyLeaves(boolean value) {
    destroyLeaves.set(value);
  }
   ...
   */
  public void setLeavesAffectDurability(boolean value) {
    leavesAffectDurability.set(value);
  }
   ...
   */
  public void setReplantSaplings(boolean value) {
    replantSaplings.set(value);
  }
   ...
   */
  public void setUseShearsOnLeaves(boolean value) {
    useShearsOnLeaves.set(value);
  }
   ...
   */
  public void setLeafRange(int value) {
    leafRange.set(value);
  }
   ...
   */
  public void setTrunkRange(int value) {
    trunkRange.set(value);
  }
   ...
   */
  public void setLogs(List<? extends String> value) {
    logs.set(value);
  }
   ...
   */
  public void setLeaves(List<? extends String> value) {
    leaves.set(value);
  }
   ...
   */
  public void setAxes(List<? extends String> value) {
    axes.set(value);
  }
