...
public class MAConfig_Client extends MAConfig_Base {
	 ...
	 */
	public boolean disableParticleEffects() { return disableParticleEffects.get(); }
	...
	public void setDisableParticleEffects(boolean value) {
		...
		if (value && MAParticleManager.getOriginal() != null) { ClientFunctions.mc.particles = MAParticleManager.getOriginal(); }
	}
