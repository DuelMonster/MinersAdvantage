...
public class MAConfig_Common extends MAConfig_BaseCategory {
	...
	private final BooleanValue breakAtToolSpeeds;
	...
	public MAConfig_Common(ForgeConfigSpec.Builder builder) {
		...
		breakAtToolSpeeds = builder
				.comment("Breaks blocks at the speed of the tool being used. [CURRENTLY UNUSED]")
				.translation("minersadvantage.common.break_at_tool_speeds")
				.define("break_at_tool_speeds", MAConfig_Defaults.Common.breakAtToolSpeeds);
	 ...
	 */
	public void set_tpsGuard(boolean value) { tpsGuard.set(value); }
	 ...
	 */
	public void setGatherDrops(boolean value) { gatherDrops.set(value); }
	 ...
	 */
	public void setAutoIlluminate(boolean value) { autoIlluminate.set(value); }
	 ...
	 */
	public void setMineVeins(boolean value) { mineVeins.set(value); }
	 ...
	 */
	public void setBlocksPerTick(int value) { blocksPerTick.set(value); }
	 ...
	 */
	public void setEnableTickDelay(boolean value) { enableTickDelay.set(value); }
	 ...
	 */
	public void setTickDelay(int value) { tickDelay.set(value); }
	 ...
	 */
	public void setBlockRadius(int value) { blockRadius.set(value); }
	 ...
	 */
	public void setBlockLimit(int value) { blockLimit.set(value); }
	...
	/**
	 * @param breakAtToolSpeeds Sets breakAtToolSpeeds
	 */
	public void setBreakAtToolSpeeds(boolean value) { breakAtToolSpeeds.set(value); }
