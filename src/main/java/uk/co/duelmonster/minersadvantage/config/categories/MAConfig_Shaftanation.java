...
public class MAConfig_Shaftanation extends MAConfig_BaseCategory {
	...
	public MAConfig_Shaftanation(ForgeConfigSpec.Builder builder) {
		...
		torchPlacement = builder
				.comment("Where torches should be placed when Auto Illumination is enabled:  Floor (default), Left Wall or Right Wall (2 blocks up from shaft floor).")
	...
	/**
	 * @param shaftLength Sets shaftLength
	 */
	public void setShaftLength(int value) { shaftLength.set(value); }
	...
	/**
	 * @param shaftHeight Sets shaftHeight
	 */
	public void setShaftHeight(int value) { shaftHeight.set(value); }
	...
	/**
	 * @param shaftWidth Sets shaftWidth
	 */
	public void setShaftWidth(int value) { shaftWidth.set(value); }
	...
	/**
	 * @param torchPlacement Sets torchPlacement
	 */
	public void setTorchPlacement(TorchPlacement value) { torchPlacement.set(value); }

	public void setTorchPlacement(String value) { torchPlacement.set(TorchPlacement.byName(value)); }
