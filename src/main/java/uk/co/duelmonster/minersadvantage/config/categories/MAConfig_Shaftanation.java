...
public class MAConfig_Shaftanation extends MAConfig_BaseCategory {
  ...
  public MAConfig_Shaftanation(ForgeConfigSpec.Builder builder) {
    ...
    torchPlacement = builder
        .comment("Where torches should be placed when Auto Illumination is enabled:  FLOOR (default), LEFT_WALL, RIGHT_WALL or BOTH_WALLS (2 blocks up from shaft floor).")
