...
public class Functions {
	...
	public static String localize(String key) { return (new TranslationTextComponent(key)).getFormattedText(); }

	public static boolean isDebug() { return java.lang.management.ManagementFactory.getRuntimeMXBean().getInputArguments().stream().anyMatch(s -> s.contains("jdwp")); }

	public static void DebugNotifyClient(PlayerEntity player, String sMsg) { if (isDebug()) { NotifyClient(player, sMsg); } }

	public static void DebugNotifyClient(PlayerEntity player, boolean bIsOn, String sFeatureName) { if (isDebug()) { NotifyClient(player, bIsOn, sFeatureName); } }

	public static void NotifyClient(PlayerEntity player, String sMsg) { player.sendStatusMessage(new StringTextComponent(Constants.MOD_NAME_MSG + sMsg), false); }
	...
	public static void playSound(World world, BlockPos pos, SoundEvent sound, SoundCategory soundCategory, float volume, float pitch) { playSound(world, null, pos, sound, soundCategory, volume, pitch); }
	...
	public static ItemStack getStackOfClassTypeFromHotBar(PlayerInventory inventory, Class<?> classType) { return getStackOfClassTypeFromInventory(PlayerInventory.getHotbarSize(), inventory, classType); }

	public static ItemStack getStackOfClassTypeFromInventory(PlayerInventory inventory, Class<?> classType) { return getStackOfClassTypeFromInventory(inventory.getSizeInventory(), inventory, classType); }
	...
	public static String getName(ItemEntity itemEntity) { return getName(itemEntity.getItem()); }

	public static String getName(ItemStack itemStack) { return getName(itemStack.getItem()); }

	public static String getName(Item item) { return item.getRegistryName().toString().trim(); }

	public static String getName(Block block) { return block.getRegistryName().toString().trim(); }

	public static String getName(BlockState state) { return state.getBlock().getRegistryName().toString().trim(); }

	public static Block getBlockFromWorld(World world, BlockPos pos) { return world.getBlockState(pos).getBlock(); }
	...
	public static boolean canSustainPlant(World world, BlockPos pos, IPlantable plantable) { return world.getBlockState(pos).canSustainPlant(world, pos, Direction.UP, plantable); }
