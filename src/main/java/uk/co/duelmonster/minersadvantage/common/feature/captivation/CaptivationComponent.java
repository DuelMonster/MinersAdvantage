...
/**
 * CaptivationComponent keeps this part of MinersAdvantage running without turning server ticks into confetti.
...
public final class CaptivationComponent implements ComponentLifecycle {
  ...
  private CaptivationCoreService.CaptureDecision lastDecision = new CaptivationCoreService.CaptureDecision(false, false,
      false);
