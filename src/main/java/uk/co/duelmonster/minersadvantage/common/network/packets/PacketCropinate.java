...
/**
 * PacketCropinate is the teammate that keeps this part of the mod understandable and stable.
 * It exists so behavior stays explicit instead of becoming mystery spaghetti at 2 AM.
 */
public class PacketCropinate extends BaseBlockPacket {
    /**
     * PacketCropinate exists to keep this step focused, predictable, and debuggable.
