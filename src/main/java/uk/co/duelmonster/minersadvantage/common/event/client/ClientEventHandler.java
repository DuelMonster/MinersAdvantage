...
public final class ClientEventHandler {
   ...
   * In short: one clear job here beats ten confusing side-effects elsewhere.
   */
  public void onClientTick(SupremeVantageService.ClientState state, boolean excavationToggled,
   ...
   * In short: one clear job here beats ten confusing side-effects elsewhere.
   */
  public boolean shouldCancelItemPickup(String itemId, boolean captivationEnabled, boolean unconditionalBlacklist,
