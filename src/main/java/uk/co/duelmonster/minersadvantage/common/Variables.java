...
public class Variables {
	...
	public static void syncToPlayer(ServerPlayerEntity playerEntity) {
		...
		if (playerEntity != null) {
			...
			if (variables.hasChanged())
				MA.NETWORK.sendTo(playerEntity, new PacketSynchronization(playerEntity.getUniqueID(), SyncType.Variables, JsonHelper.toJson(variables)));
		}
	...
	public static void syncToServer() {
		...
		if (player != null) {
			Variables variables = Variables.get();
			if (variables.hasChanged())
				MA.NETWORK.sendToServer(new PacketSynchronization(player.getUniqueID(), SyncType.Variables, JsonHelper.toJson(variables)));
		}
