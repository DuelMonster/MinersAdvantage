...
public class Variables {
    ...
    // Why this exists: --- Core migrated fields from legacy --- (future-you will thank present-you).
    ...
    // Why this exists: Substitution variables (future-you will thank present-you).
