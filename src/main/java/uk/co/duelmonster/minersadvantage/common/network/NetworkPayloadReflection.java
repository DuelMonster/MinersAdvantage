...
final class NetworkPayloadReflection {
  ...
  static Object createIdentifier(Class<?> identifierClass, String path) throws ReflectiveOperationException {
    ...
    throw new NoSuchMethodException("Unable to construct identifier for class " + identifierClass.getName()
        + " (last error: " + (lastException == null ? "none" : lastException.getMessage()) + ")");
  }
