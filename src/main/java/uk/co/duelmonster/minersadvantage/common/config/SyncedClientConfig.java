  ...
  public static SyncedClientConfig defaults() {
    return new SyncedClientConfig(
        ...
        new CommonConfig(
            ...
            MAConfig_Defaults.Common.maxActiveCaptivationAgent,
            MAConfig_Defaults.Common.maxActiveCropinationAgent,
            MAConfig_Defaults.Common.maxActiveCultivationAgent,
            MAConfig_Defaults.Common.maxActiveExcavationAgent,
            MAConfig_Defaults.Common.maxActiveIlluminationAgent,
            MAConfig_Defaults.Common.maxActiveLumbinationAgent,
            MAConfig_Defaults.Common.maxActivePathanationAgent,
            MAConfig_Defaults.Common.maxActiveShaftanationAgent,
            MAConfig_Defaults.Common.maxActiveSubstitutionAgent,
            MAConfig_Defaults.Common.maxActiveVeinationAgent,
            MAConfig_Defaults.Common.maxActiveVentilationAgent,
            MAConfig_Defaults.Common.dedupeCaptivationAgent,
            MAConfig_Defaults.Common.dedupeCropinationAgent,
            MAConfig_Defaults.Common.dedupeCultivationAgent,
            MAConfig_Defaults.Common.dedupeExcavationAgent,
            MAConfig_Defaults.Common.dedupeIlluminationAgent,
            MAConfig_Defaults.Common.dedupeLumbinationAgent,
            MAConfig_Defaults.Common.dedupePathanationAgent,
            MAConfig_Defaults.Common.dedupeShaftanationAgent,
            MAConfig_Defaults.Common.dedupeSubstitutionAgent,
            MAConfig_Defaults.Common.dedupeVeinationAgent,
            MAConfig_Defaults.Common.dedupeVentilationAgent),
