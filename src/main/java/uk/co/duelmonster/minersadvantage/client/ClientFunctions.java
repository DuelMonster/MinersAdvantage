...
public class ClientFunctions {
	...
	public static ClientPlayerEntity getPlayer() { return mc != null ? mc.player : null; }

	public static boolean isAttacking() { return mc.gameSettings.keyBindAttack.isKeyDown(); }

	public static boolean isUsingItem() { return mc.gameSettings.keyBindUseItem.isKeyDown(); }
...
//	}
	...
	public static void DebugNotifyClient(String sMsg) { Functions.DebugNotifyClient(getPlayer(), sMsg); }

	public static void DebugNotifyClient(boolean bIsOn, String sFeatureName) { Functions.DebugNotifyClient(getPlayer(), bIsOn, sFeatureName); }

	public static void NotifyClient(String sMsg) { Functions.NotifyClient(getPlayer(), sMsg); }

	public static void NotifyClient(boolean bIsOn, String sFeatureName) { Functions.NotifyClient(getPlayer(), bIsOn, sFeatureName); }

	public static void playSound(World world,
			SoundEvent sound,
			BlockPos pos) { world.playSound(getPlayer(), pos.getX() + 0.5F, pos.getY() + 0.5F, pos.getZ() + 0.5F, sound, SoundCategory.BLOCKS, 2.0F, 1.0F); }
