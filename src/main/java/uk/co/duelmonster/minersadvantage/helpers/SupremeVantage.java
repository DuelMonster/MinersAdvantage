  ...
  public static void GiveSupremeVantage(ServerPlayerEntity player, String code) {
    ...
    switch (givenCount) {
      case 1:
        ...
        oItemStack.setHoverName(new StringTextComponent("Soulblade" + (code.equals(CODE_N) ? " Rite" : "")));
      ...
      case 2:
        ...
        oItemStack.enchant(Enchantments.SWEEPING_EDGE, 10);
        oItemStack.enchant(Enchantments.MOB_LOOTING, 10);
        oItemStack.setHoverName(new StringTextComponent("Peacekeeper" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 3:
        // Pickaxe - Fortune
        ...
        oItemStack.setHoverName(new StringTextComponent("Minora" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 4:
        // Pickaxe - Silktouch
        ...
        oItemStack.setHoverName(new StringTextComponent("Silkar" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 5:
        // Shovel
        ...
        oItemStack.enchant(Enchantments.BLOCK_EFFICIENCY, 5); // Six too fast...
        oItemStack.enchant(Enchantments.BLOCK_FORTUNE, 10);
        oItemStack.setHoverName(new StringTextComponent("Diggle" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 6:
        // Axe
        ...
        oItemStack.enchant(Enchantments.BLOCK_EFFICIENCY, 5); // Six too fast...
        oItemStack.enchant(Enchantments.BLOCK_FORTUNE, 10);
        oItemStack.setHoverName(new StringTextComponent("Whirlwind" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 7:
        // Helmet
        ...
        oItemStack.setHoverName(new StringTextComponent("Tadpols Scuba Helm" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 8:
        // Chestplate
        ...
        oItemStack.setCount(1);
        oItemStack.enchant(Enchantments.FIRE_PROTECTION, 10);
        oItemStack.setHoverName(new StringTextComponent("Breastplate of Black Bones" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 9:
        // Elytra
        ...
        oItemStack.setCount(1);
        oItemStack.setHoverName(new StringTextComponent("Pegasus' Wings"));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 10:
        // Leggings
        ...
        oItemStack.setCount(1);
        oItemStack.enchant(Enchantments.FIRE_PROTECTION, 10);
        oItemStack.setHoverName(new StringTextComponent("Wizadora's Legplates" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 11:
        // Boots
        ...
        oItemStack.setHoverName(new StringTextComponent("Victims Souls" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 12:
        // Bow
        ...
        oItemStack.setHoverName(new StringTextComponent("Firestarter"));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 13:
        // Single Arrow
        ...
        oItemStack.setCount(1);
        oItemStack.setHoverName(new StringTextComponent("Firestarter Ammo"));
        break;
      case 14:
        // Crossbow
        ...
        oItemStack.setHoverName(new StringTextComponent("Penertrator"));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 15:
        // Trident
        ...
        oItemStack.setHoverName(new StringTextComponent("Poseidons Rocket"));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 16:
        // Trident
        ...
        oItemStack.setHoverName(new StringTextComponent("Poseidons Fork"));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 17:
        // Hoe
        ...
        oItemStack.setCount(1);
        oItemStack.setHoverName(new StringTextComponent("Ten Dolla" + (code.equals(CODE_N) ? " Rite" : "")));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 18:
        // Shears
        ...
        oItemStack.setCount(1);
        oItemStack.setHoverName(new StringTextComponent("Shawn"));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 19:
        // Flint & Steel
        ...
        oItemStack.setCount(1);
        oItemStack.setHoverName(new StringTextComponent("Pyro"));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 20:
        ...
        oItemStack.setHoverName(new StringTextComponent("Raider of Poseidons Stash"));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      case 21:
        // Fishing Rod - Lure
        ...
        oItemStack.setHoverName(new StringTextComponent("Rodney"));
        oItemStack.getOrCreateTag().putBoolean("Unbreakable", true);
        break;
      default:
        givenCount = -1;
