...
public class PacketGiveItem {
	...
	public PacketGiveItem(PacketBuffer buf) { this.itemStack = buf.readItemStack(); }

	public PacketId getPacketId() { return PacketId.GiveItem; }
	...
	public static PacketGiveItem decode(PacketBuffer buf) { return new PacketGiveItem(buf); }
