...
public class PacketVeinate extends BaseBlockPacket {
	...
	public PacketVeinate(BlockPos _pos, Direction _sideHit, int _stateID) { super(_pos, _sideHit, _stateID); }

	public PacketVeinate(PacketBuffer buf) { super(buf); }

	@Override
	public PacketId getPacketId() { return PacketId.Veinate; }
	...
	public static PacketVeinate decode(PacketBuffer buf) { return new PacketVeinate(buf); }
