...
public class PacketShaftanate extends BaseBlockPacket {
	...
	public PacketShaftanate(BlockPos _pos, Direction _sideHit, int _stateID) { super(_pos, _sideHit, _stateID); }
	public PacketShaftanate(PacketBuffer buf) { super(buf); }

	@Override
	public PacketId getPacketId() { return PacketId.Shaftanate; }
	...
	public static PacketShaftanate decode(PacketBuffer buf) { return new PacketShaftanate(buf); }
