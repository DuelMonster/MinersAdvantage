...
public class IlluminationPlaceAgent extends Agent {
   ...
   */
  public IlluminationPlaceAgent(ServerPlayer player, BlockPos target, Direction faceDirection,
      IlluminationConfig config, CommonConfig commonConfig) {
    super(player);
    this.target = target;
  ...
  public boolean tick() {
    ...
    world.playSound(null, target, net.minecraft.sounds.SoundEvents.WOOD_PLACE, net.minecraft.sounds.SoundSource.BLOCKS,
