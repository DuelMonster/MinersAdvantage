	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		...
		if (FMLClientHandler.instance().getClient().inGameHasFocus) {
			...
			if (KeyBindings.captivation.isPressed()) {
				settings.bCaptivationEnabled = !settings.bCaptivationEnabled;
			...
			if (KeyBindings.excavation.isPressed()) {
				settings.bExcavationEnabled = !settings.bExcavationEnabled;
			...
			if (KeyBindings.illumination.isPressed()) {
				settings.bIlluminationEnabled = !settings.bIlluminationEnabled;
			...
			if (KeyBindings.lumbination.isPressed()) {
				settings.bLumbinationEnabled = !settings.bLumbinationEnabled;
			...
			if (KeyBindings.shaftanation.isPressed()) {
				settings.bShaftanationEnabled = !settings.bShaftanationEnabled;
			...
			if (KeyBindings.substitution.isPressed()) {
				settings.bSubstitutionEnabled = !settings.bSubstitutionEnabled;
			...
			if (KeyBindings.veination.isPressed()) {
				settings.bVeinationEnabled = !settings.bVeinationEnabled;
